...
function nectar_register_js() {	
	...
	if (!is_admin()) { 
		...
		wp_register_script('nectar_prettyPhoto', get_template_directory_uri() . '/js/prettyPhoto.js', 'jquery', '4.5', TRUE);
		...
		wp_register_script('nectarSlider', get_template_directory_uri() . '/js/nectar-slider.js', 'jquery', '4.5.1', TRUE);
		wp_register_script('ajaxify', get_template_directory_uri() . '/js/ajaxify.js', 'jquery', '4.5.1', TRUE);

		if ( floatval(get_bloginfo('version')) < "3.6" ) {
			wp_register_script('jplayer', get_template_directory_uri() . '/js/jplayer.min.js', 'jquery', '2.1', TRUE);
		}
		wp_register_script('nectarFrontend', get_template_directory_uri() . '/js/init.js', array('jquery', 'superfish', 'carouFredSel', 'flexslider'), '4.5', TRUE);
...
function nectar_main_styles() {	
		 ...
		 // Register 
		 wp_register_style('rgs', get_template_directory_uri() . '/css/rgs.css', '', '4.5');
		 ...
		 wp_register_style("main-styles", get_stylesheet_directory_uri() . "/style.css", '', '4.5');
		 wp_register_style("responsive", get_template_directory_uri() . "/css/responsive.css", '', '4.5');
		 wp_register_style("non-responsive", get_template_directory_uri() . "/css/non-responsive.css");
		 wp_register_style("skin-ascend", get_template_directory_uri() . "/css/ascend.css", '', '4.5');
...
if ( !function_exists( 'nectar_page_header' ) ) {
    function nectar_page_header($postid) {
		...
		$wrapper_height_style = ($fullscreen_header == true && ($post->post_type == 'post' && is_single())) ?  null : 'style="height: '.$height.'px;"';
