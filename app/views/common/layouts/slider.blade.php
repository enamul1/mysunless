...
<li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400"
    data-thumb="/assets/common/pages/img/revolutionslider/thumbs/thumb2.jpg">
    <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
    <img src="/assets/common/pages/img/revolutionslider/bg9.jpg" alt="">
    ...
    <div class="caption lfb"
         ...
         data-start="1000"
         data-easing="easeOutExpo">
        <img src="/assets/common/pages/img/revolutionslider/lady.png" alt="Image 1">
    </div>
</li>
...
<li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400"
    data-thumb="/assets/common/pages/img/revolutionslider/thumbs/thumb2.jpg">
    <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
    <img src="/assets/common/pages/img/revolutionslider/bg1.jpg" alt="">
    ...
    <div class="caption lfb"
         ...
         data-start="1000"
         data-easing="easeOutExpo">
        <img src="/assets/common/pages/img/revolutionslider/man-winner.png" alt="Image 1">
    </div>
</li>
...
<li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-delay="9400"
    data-thumb="/assets/common/pages/img/revolutionslider/thumbs/thumb2.jpg">
    <img src="/assets/common/pages/img/revolutionslider/bg2.jpg" alt="">
    ...
    <div class="caption lfr slide_item_right"
        ...
        <img src="/assets/common/pages/img/revolutionslider/mac.png" alt="Image 1">
    </div>
    <div class="caption lfr slide_item_right"
         data-x="580"
         data-y="245"
         ...
         data-start="2000"
         data-easing="easeOutBack">
        <img src="/assets/common/pages/img/revolutionslider/ipad.png" alt="Image 1">
    </div>
    <div class="caption lfr slide_item_right"
         data-x="735"
         data-y="290"
         ...
         data-start="2500"
         data-easing="easeOutBack">
        <img src="/assets/common/pages/img/revolutionslider/iphone.png" alt="Image 1">
    </div>
    <div class="caption lfr slide_item_right"
         data-x="835"
         data-y="230"
         ...
         data-start="3000"
         data-easing="easeOutBack">
        <img src="/assets/common/pages/img/revolutionslider/macbook.png" alt="Image 1">
    </div>
    <div class="caption lft slide_item_right"
         ...
         data-start="5000"
         data-easing="easeOutBack">
        <img src="/assets/common/pages/img/revolutionslider/hint1-red.png" id="rev-hint1" alt="Image 1">
    </div>
    <div class="caption lfb slide_item_right"
         ...
         data-start="5500"
         data-easing="easeOutBack">
        <img src="/assets/common/pages/img/revolutionslider/hint2-red.png" id="rev-hint2" alt="Image 1">
    </div>
</li>
...
<li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400"
    data-thumb="/assets/common/pages/img/revolutionslider/thumbs/thumb2.jpg">
    <img src="/assets/common/pages/img/revolutionslider/bg3.jpg" alt="">
...
<li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400"
    data-thumb="/assets/common/pages/img/revolutionslider/thumbs/thumb2.jpg">
    <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
    <img src="/assets/common/pages/img/revolutionslider/bg4.jpg" alt="">
    ...
    <div class="caption lft start"
         ...
         data-start="2000"
         data-easing="easeOutBack">
        <img src="/assets/common/pages/img/revolutionslider/iphone_left.png" alt="Image 2">
    </div>
    ...
    <div class="caption lft start"
         ...
         data-start="2400"
         data-easing="easeOutBack">
        <img src="/assets/common/pages/img/revolutionslider/iphone_right.png" alt="Image 3">
    </div>
</li>
</ul>
