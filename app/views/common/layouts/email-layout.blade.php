								...
								<tr>
									<td>
										...
										<tr>
											<td class="vertical-middle">
												<a href="#">
												<img src="{{url(URL::to('/'))}}/assets/dashboard/pages/media/email/social_facebook.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="{{url(URL::to('/'))}}/assets/dashboard/pages/media/email/social_twitter.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="{{url(URL::to('/'))}}/assets/dashboard/pages/media/email/social_googleplus.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="{{url(URL::to('/'))}}/assets/dashboard/pages/media/email/social_linkedin.png" alt="social icon"/>
												</a>
											</td>
										</tr>
										</table>
