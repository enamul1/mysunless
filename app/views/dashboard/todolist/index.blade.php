							...
							<div class="row">
								...
								<div class="col-md-7 col-sm-8">
									<div class="scroller" style="max-height: 600px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
										...
										{{ Form::open(array('url' => '/dashboard/todo/store', 'class' => 'form-horizontal todo-create', 'role'=>'form')) }}
											<!-- TASK HEAD -->
											<div class="form">
												<!-- END TASK HEAD -->
												<!-- TASK TITLE -->
												<div class="form-group">
													<div class="col-md-12">
														<input id="title" type="text" name='title' class="form-control todo-taskbody-tasktitle" placeholder="Task Title...">
												...
												<div class="form-group">
													<div class="col-md-12">
														<div class="input-icon">
															...
															<input name='due_date' type="text" class="form-control todo-taskbody-due" placeholder="Due Date...">
												...
												<div class="form-group">
													<div class="col-md-12">
														<select id="tags" name = "tags[]" class="form-control todo-taskbody-tags" multiple="" placeholder="Tags...">
														@foreach($tags as $tag)
												...
												<div class="form-actions right todo-form-actions">
													<button id="todo-submit" class="btn btn-circle btn-sm green-haze">Create Task</button>
													<!-- <button class="btn btn-circle btn-sm btn-default">Cancel</button>
													<button class="btn btn-circle btn-sm btn-default">Mark Complete</button> -->
												</div>
											</div>
										<!-- </form> -->
										{{ Form::close() }}
