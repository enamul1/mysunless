						...
						<div class="col-md-9">
							<div class="tab-content" id="success-message">
								<div id="tab_1-1" class="tab-pane active">
									...
									<div class="form-group">
									    {{ HTML::decode(Form::label('company', 'Company Name:<span class="require">*</span>', array('class' => 'control-label'))) }}
									    
									    {{ Form::text('company', $value = null, array( 'required' => 'required', 'class' => 'form-control' )) }}
									</div>
									<div class="form-group">
									    {{ HTML::decode(Form::label('company_type', 'Company Type:<span class="require">*</span>', array('class' => 'control-label'))) }}
									    {{Form::select('company_type', array('MOBILE_TANNING_BUSSINESS' => 'MOBILE TANNING BUSSINESS', 'SALON_BASED_BUSINESS' => 'SALON BASED BUSINESS'),$value = null, array('required' => 'required', 'class' => 'form-control' )) }}
									</div>
									<div class="form-group">
									    {{ HTML::decode(Form::label('company_website', 'Company Website:', array('class' => 'control-label'))) }}
									...
									<div class="form-group">
									    {{ HTML::decode(Form::label('address2', 'Secondary Address', array('class' => 'control-label'))) }}
									    
									    {{ Form::text('address2', $value = null, array( 'required' => 'required', 'class' => 'form-control' )) }}
									</div>
									<div class="form-group">
									...
									<div class="margiv-top-10">
										...
										<a href="{{url(URL::to('/dashboard'))}}" class="btn default">
											Cancel 
										</a>
									</div>
									{{ Form::close() }}
