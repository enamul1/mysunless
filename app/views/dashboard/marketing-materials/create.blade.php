				...
				<div class="tab-pane active" id="tab_5">
					<div class="portlet box blue ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-briefcase"></i>Add new marketing material
							</div>
						</div>
						<div class="portlet-body form">
							@if($notificationMessage)
				                <div class="alert alert-success">
				                    ...
				                    <strong>You have successfully added a new material.</strong>
				                </div>
				            @endif
							<!-- BEGIN FORM-->
							{{ Form::open(array('url' => '/dashboard/marketing-material/store', 'class' => 'form-horizontal', 'role'=>'form', 'files' => true)) }}
								<div class="form-body">
									...
									<div class="form-group">
										{{ HTML::decode(Form::label('upload', 'Upload<span class="require">*</span>', array('class' => 'control-label col-md-3'))) }}
										<div class="col-md-9">
