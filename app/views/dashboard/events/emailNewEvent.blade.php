...
<title>MySunless.com<br>
    Spray Tanning and Sunless</title>
<!--IMPORTANT:
                                                ...
                                                <table class="six columns">
                                                    <tr>
                                                        <td class="vertical-middle">
                                                            <a href="index.html">
                                                                <img src="/assets/dashboard/layout/img/logo.png" width="86" height="14" border="0" alt=""/>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                        ...
                                                        <td>
                                                            <table class="wrapper social-icons" align="right">
                                                                <tr>
                                                                    <td class="vertical-middle">
                                                                        <a href="#">
                                                                            <img src="/assets/dashboard/pages/media/email/social_facebook.png" alt="social icon"/>
                                                                        </a>
                                                                    </td>
                                                                    <td class="vertical-middle">
                                                                        <a href="#">
                                                                            <img src="/assets/dashboard/pages/media/email/social_twitter.png" alt="social icon"/>
                                                                        </a>
                                                                    </td>
                                                                    <td class="vertical-middle">
                                                                        <a href="#">
                                                                            <img src="/assets/dashboard/pages/media/email/social_googleplus.png" alt="social icon"/>
                                                                        </a>
                                                                    </td>
                                                                    <td class="vertical-middle">
                                                                        <a href="#">
                                                                            <img src="/assets/dashboard/pages/media/email/social_linkedin.png" alt="social icon"/>
                                                                        </a>
                                                                    </td>
                                                                    <td class="vertical-middle">
                                                                        <a href="#">
                                                                            <img src="/assets/dashboard/pages/media/email/social_rss.png" alt="social icon"/>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                        ...
                        <table class="row note">
                            <tr>
                                <td class="wrapper last">
                                    <h4>An event of service has been created for you by <h3>{{$eventDetails['business_name']}}</h3></h4>
                                    <p>
                                        Details of Service:
                                    </p>
                                    <!-- BEGIN: Note Panel -->
                                    <table class="twelve columns" style="margin-bottom: 10px">
                                        <tr>
                                            <td class="panel">
                                                ...
                                                <p>
                                                    <strong>Date of Service:</strong> {{$eventDetails['serviceDate']}}
                                                </p>
                                                <p>
                                                    <strong>Cost Of Service:</strong> ${{$eventDetails['cost']}}
                                                </p>
                                            </td>
                                            <td class="expander">
                                            </td>
                                    ...
                                    <table class="twelve columns">
                                        <tr>
                                            <td>
                                                <h4>Instructions</h4>
                                                <p>
                                                    {{$eventDetails['email_instruction']}}
                                                </p>
                                            </td>
                                            <td class="expander">
                                            </td>
